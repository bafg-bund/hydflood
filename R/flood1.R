...
#'   and Rhine based on 1D water levels computed by \code{waterLevelFlood1()} 
...
#'   Internally \code{waterLevelFlood1()} uses \code{getGaugingDataW()} to 
...
#'   a 1D water level using \code{waterLevelFlood1} along the requested river
...
flood1 <- function(x, seq, gauging_station, uuid, filename = '', ...) {
    ...
    attributes <- append(attributes, paste0("flood duration computed by hydflo",
                                            "od3::flood1() for the following t",
