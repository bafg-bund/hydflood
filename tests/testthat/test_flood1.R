...
test_that("flood1: checks", {
    ...
    expect_equal(class(flood1(x, seq, "ROSSLAU"))[1], "RasterLayer")
    ...
    expect_error(flood1(x, seq), "The 'gauging_station' or 'uuid' argument has")
    
    # gauging station class
    expect_error(flood1(x, seq, 1), "'gauging_station' must be type 'character")
    ...
    expect_error(flood1(x, seq, uuid = "b8567c1e-8610-4c2b-a240-65e8a74919fa"),
                 "has to be in the river stretch", fixed = TRUE)
