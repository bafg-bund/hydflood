...
# output paths
dir.create("vignettes/movie/2013", verbose, TRUE)
...
for (h in seq) {
    ...
    out_file <- paste0("vignettes/movie/2013/flood3_", sprintf("%03d", j), 
                       ".jpg")
    ...
    boxed.labels(as.Date("2013-08-15"), mw, "MW", cex = 0.8, border = FALSE)
...
system(paste0("ffmpeg -y -framerate 1 -i vignettes/movie/2013/flood3_%03d.jpg ",
              "-c:v libx264 -r 30 -pix_fmt yuv420p vignettes/movie/2013/",
              "flood3.mp4"))
