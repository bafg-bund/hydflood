...
# compute fe_mthw
if (!file.exists(filename_mthw)) {
    fe_mthw <- floodCharacteristicWaterlevel(x, "MThw", 
        filename = filename_mthw, format = "GTiff", datatype = datatype)
} else {
    fe_mthw <- rast(filename_mthw)
}
...
# compute fe_mtnw
if (!file.exists(filename_mtnw)) {
    fe_mtnw <- floodCharacteristicWaterlevel(x, "MTnw",
        filename = filename_mtnw, format = "GTiff", datatype = datatype)
} else {
    fe_mtnw <- rast(filename_mtnw)
}
