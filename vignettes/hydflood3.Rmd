...
[`hyd1d`](http://r.bafg.de/~WeberA/hyd1d/) .
[`hyd1d`](http://r.bafg.de/~WeberA/hyd1d/) internally provides gauging
...
with the package [`hyd1d`](http://r.bafg.de/~WeberA/hyd1d/). Therefore
...
[`WaterLevelDataFrame`](http://r.bafg.de/~WeberA/hyd1d/reference/WaterLevelDataFrame-class.html)
computed by the
[`waterLevel`](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevel.html)
function of package [`hyd1d`](http://r.bafg.de/~WeberA/hyd1d/). To 
...
2. Creation of a [`WaterLevelDataFrame`](http://r.bafg.de/~WeberA/hyd1d/reference/WaterLevelDataFrame-class.html) for the selected river section
3. Computation of the 1D water level using the [`waterLevel`](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevel.html) function of package [`hyd1d`](http://r.bafg.de/~WeberA/hyd1d/)
4. Transfer of the 1D water level information from the [`WaterLevelDataFrame`](http://r.bafg.de/~WeberA/hyd1d/reference/WaterLevelDataFrame-class.html) to the cross section areas (`csa`) through the join field `station_int`
...
<video width="640" height="480" style="display:block; margin: 0 auto;" controls>
  <source src="http://r.bafg.de/~WeberA/hydflood3/articles/flood3-2fps-dessau.mp4" type="video/mp4">
...
<video width="640" height="480" style="display:block; margin: 0 auto;" controls>
  <source src="http://r.bafg.de/~WeberA/hydflood3/articles/flood3-2fps-lenzen.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
